/**
 * fix/session-list-active-flag — the WS `session_list` payload MUST carry the
 * same derived fields as `GET /api/sessions`.
 *
 ...
 * (web/src/hooks/useSessions.ts), and the hub pushes one immediately on
