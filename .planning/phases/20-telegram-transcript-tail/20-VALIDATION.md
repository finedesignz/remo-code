...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|--------|
| 20-01-01 | 01 | 1 | R-TG-01 | T-20-02 | bridge sees only TranscriptEntry; selectAdapter by cliKind | unit | `bun test hub/test/transcript-backend-agnostic.test.ts` | ✅ green |
| 20-01-02 | 01 | 1 | R-TG-02 | T-20-01 | Claude file resolved deterministically; unknown type skipped | unit | `bun test hub/test/transcript-adapter-claude.test.ts` | ✅ green |
| 20-01-03 | 01 | 1 | R-TG-03 | T-20-03 | Codex rollout by session_meta id; fallback emits no permission_request | unit | `bun test hub/test/transcript-adapter-codex.test.ts` | ✅ green |
| 20-02-01 | 02 | 2 | R-TG-04 | T-20-04/05 | final assistant_text only; no onAssistantMessageFinal import | unit | `bun test hub/test/telegram-output-from-transcript.test.ts` | ✅ green |
| 20-03-01 | 03 | 2 | R-TG-06 | T-20-06 | malformed permission ⇒ zero prompts + zero keystrokes | unit (neg) | `bun test hub/test/telegram-permission-failclosed.test.ts` | ✅ green |
| 20-03-02 | 03 | 2 | R-TG-05/07/09 | T-20-07/08/09 | (sessionId,requestId) keying; no collision; stale/unauth tap rejected | unit | `bun test hub/test/telegram-permission-disambiguation.test.ts` | ✅ green |
| 20-03-03 | 03 | 2 | R-TG-08 | T-20-07 | injected bytes match mapping; correct PTY only; no permission_response | unit | `bun test hub/test/telegram-keystroke-inject.test.ts` | ✅ green (bytes provisional — manual gate) |
| 20-04-01 | 04 | 3 | R-TG-10 | T-20-10/11/12 | queued not interleaved; release on turn_complete; response bypasses lock | unit | `bun test hub/test/pty-turn-lock.test.ts` | ✅ green |
| 20-05-01 | 05 | 4 | R-TG-11 | T-20-13 | human msg allowed; automation Telegram-origin rejected | unit (neg) | `bun test hub/test/telegram-human-only-guard.test.ts` | ✅ green |
