export function Footer() {
  ...
  return (
    <footer className="w-full border-t border-[var(--border-color)] bg-[var(--bg-primary)] py-2 px-4 text-xs text-[var(--text-muted)] hidden md:flex items-center justify-between gap-4 shrink-0">
