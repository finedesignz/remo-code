      ...
      <div className="bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <p className="text-slate-400 text-sm mb-6">
            Session <span className="text-white font-medium">{sessionName}</span> created.
          </p>
          ...
          <div className="mb-5 p-4 bg-indigo-900/20 border border-indigo-800/50 rounded-xl">
            ...
            <p className="text-xs text-slate-400 mb-3">
              Generate an API key from the <strong className="text-white">API Key</strong> button in the sidebar.
          ...
          <button
            ...
            className="w-full text-left text-xs text-slate-500 hover:text-slate-300 mb-4 flex items-center gap-1 transition-colors"
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <span className="w-5 h-5 rounded-full bg-slate-600 text-white text-[10px] font-bold flex items-center justify-center flex-shrink-0">1</span>
                  <h3 className="text-xs font-semibold text-slate-300">Create config file</h3>
                </div>
                <p className="text-[11px] text-slate-500 ml-7 mb-1.5">
                  Save to <code className="text-slate-400">~/.claude/channels/remo-code/.env</code>
                </p>
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <span className="w-5 h-5 rounded-full bg-slate-600 text-white text-[10px] font-bold flex items-center justify-center flex-shrink-0">2</span>
                  <h3 className="text-xs font-semibold text-slate-300">Start Claude Code</h3>
                </div>
                <div className="ml-7 relative group">
          ...
          <button
            onClick={onClose}
            className="w-full mt-4 py-3 bg-indigo-600 hover:bg-indigo-500 rounded-xl text-white font-medium transition-colors"
          >
            Done
          </button>
        </div>
