          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-end gap-2 pt-1">
              ...
              <button
                ...
                className="rounded-lg bg-blue-600 px-3 py-2 text-xs text-[var(--text-on-accent)] hover:bg-blue-500 disabled:opacity-50"
              >
            ...
            <div className="h-2 rounded bg-[var(--bg-tertiary)] overflow-hidden">
              <div
                className={`h-full transition-all duration-300 ${
                  job.stage === 'failed' ? 'bg-red-500' : 'bg-blue-500'
                }`}
                style={{ width: `${pct}%` }}
              />
            </div>
              ...
              <div className="rounded-lg bg-red-500/10 ring-1 ring-red-500/30 px-3 py-2 text-xs text-red-300">
                ...
                <div className="mt-2 flex items-center gap-2">
                  <button
                    type="button"
                    onClick={retry}
                    className="rounded-lg px-2 py-1 text-[11px] bg-blue-600 hover:bg-blue-500 text-[var(--text-on-accent)]"
                  >
                    Retry
                  </button>
                  <button
